...
const Sidebar = () => {
    ...
    return (
        <div className='flex flex-col gap-3 '>
            ...
            <div className=' shadow-sm py-5 px-2 flex flex-col items-center justify-center gap-3'>
                ...
                {manageItems.map((item, i) => (
                    <Link
                        ...
                        key={i}
                        className={
                            ` ${path === `/profile${item.path}`  ?  "bg-[#dee9f7] text-black " : " primaryBg2 text-white hover:text-gray-900 "}  inline-block w-full py-2 px-1  shadow-sm  capitalize font-medium text-center`
                        }
                    >
                        {item.item}
                    </Link>
