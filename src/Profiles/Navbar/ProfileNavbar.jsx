    ...
    return (
        <div className='px-5 md:px-10 py-5 md:py-0 flex items-center justify-between flex-wrap h-auto md:h-[100px] sticky top-0  primaryBg z-[111] border-b border-b-red-500 text-center'>
            <div className={` w-full md:w-[280px] flex items-center justify-between   px-2 md:p-4 h-full `}>
                ...
                <span onClick={handleArrowClick} className={` text-2xl md:text-3xl font-bold primaryBg2 py-2 px-3  rounded-md text-gray-50 hover:text-gray-200 duration-200 cursor-pointer`}>
                    {
                        profileArrow ? <MdClose className={` ${profileArrow ? " rotate-0" : " rotate-180"}`} /> : <MdMenu className={` ${profileArrow ? " rotate-0" : " rotate-180"}`} />
