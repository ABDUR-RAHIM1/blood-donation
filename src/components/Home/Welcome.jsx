    ...
    return (
        <section className=' my-10 md:my-20 wrap '>
            <div className='flex justify-between flex-wrap bg-gray-50'>
                <div className='w-full md:w-[48%] my-5 relative'>
                    <img src={help1} alt="roktojoddha" className=' w-full ' />
                    <img src={help2} alt="roktojoddha" className=' w-[300px] h-[300px] rounded-full absolute top-[50%] right-0 transform   translate-y-[-50%]' />
                </div>
                <div className='w-full md:w-[48%] my-5'>
                    ...
                    <div className=' flex  justify-between flex-wrap gap-3 px-3 md:px-0'>
